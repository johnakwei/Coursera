...
ScanData <- read.table("exdata-data-household_power_consumption/household_power_consumption.txt", header=T, sep=";", na.strings="?")
...
## Create Plot 4
## For "Setting Data Variables" section
labels <- c("Sub_metering_1","Sub_metering_2","Sub_metering_3")
columnlines <- c("black","red","blue")
## End For "Setting Data Variables" section
