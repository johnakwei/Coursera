...
extracted  <- "getdata-projectfiles-UCI HAR Dataset/UCI HAR Dataset"
dataLocation <- "http://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles2FUCI%20HAR%20Dataset.zip"
